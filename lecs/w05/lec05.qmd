...
![](img/red-strike.png){.absolute right=45% bottom="46%" width=70}
...
::: {.red-annotation .absolute top=150 left=255}
...
![](img/downarrow2.png){width="70" height="70"}
:::
...
[Arbitrary differentiable functions c, f]{.red-annotation .absolute right="0" bottom="55%"}
...
## Examples of models and solutions with LQR {.center}
...
![](img/lqr-ex1.png){.absolute .fragment .fade-out top="39%" left="370" width="32%" height="20%"}
...
:::{.fragment}
[**A**]{.red .absolute bottom="250" right="400"}

[**B**]{.red .absolute bottom="250" right="100"}
:::
...
[**A**]{.red .absolute bottom="400" right="400"}

[**B**]{.red .absolute bottom="400" right="100"}
...
the state tends to zero as well.]{.red-annotation .absolute right="0" top="45%"}
...
norm for controls.]{.red-annotation .absolute right="0" bottom="23%"}
...
[Notice how the state tends to zero.]{.red-annotation .absolute right="120" top="45%"}
...
[**A**]{.red .absolute top="150" right="530"}

[**B**]{.red .absolute top="150" right="150"}
...
[**B**]{.red .absolute top="150" right="260"}
...
![](img/lqr-ex2-txt.png){.absolute right=145 bottom=30% width="55%" .fragment}

:::{.fragment}
[**C**]{.red .absolute bottom=28% left=38%}
...
[Idea: augment the state]{.red .absolute right=200 bottom=29%}
:::
...
[$\qquad\qquad\qquad$ Solve this via LQR]{.red-annotation}
